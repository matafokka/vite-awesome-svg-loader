...
Consider using [urlImportsInLibraryMode](/loader-api-reference/interfaces/svgloaderoptions/#urlimportsinlibrarymode)
option if you're importing files as URLs.