...
<Aside type="caution" title="This is not for integrations">
  Do **NOT** use this to create custom integrations. Vanilla JS integration is almost always larger than it needs to be.
  Use `vite-awesome-svg-loader/integration-utils` instead.
  See [custom integrations guide](./guides/custom-integrations/).
