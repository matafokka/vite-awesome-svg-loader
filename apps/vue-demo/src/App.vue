<template>
  <article class="main">
    ...
    <ol>
      ...
      <li>
        <p>
          Using a color map instead of hard-coding variables. For example, we can map <span class="mono">red</span> to
          <span class="mono">var(--primary-color)</span>, <span class="mono">green</span> - to
          <span class="mono">var(--secondary-color)</span>, <span class="mono">blue</span> - to
          <span class="mono">var(--tertiary-color)</span> and so on. This allows designers and developers to work
          seamlessly and share same icon sets without any additional manual modifications.
        </p>
        ...
        <p>
          If your design system supports variables and exports icons with variables, it's better to use these variables
          as-is.
        </p>
      </li>
    </ol>
