import starIconUrl from "@/assets/svg-transformations/star.svg?url";
import starIconPreLineUrl from "@/assets/svg-transformations/star.svg?url&preserve-line-width";
import starIconCurrentColor from "@/assets/svg-transformations/star.svg?set-current-color";

import multicolorOrigUrl from "@/assets/svg-transformations/multicolor-orig.svg?url";
import multicolorReplacedUrl from "@/assets/svg-transformations/multicolor.svg?url";
